...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "bookscapmodatav4/test/integration/BooksSetListJourney.gen",
    "bookscapmodatav4/test/integration/BooksSetObjectPageJourney.gen",
    "bookscapmodatav4/test/integration/ChaptersObjectPageJourney.gen",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
